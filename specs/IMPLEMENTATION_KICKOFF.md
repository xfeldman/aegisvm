...
Post-implementation documentation for each milestone (corrections, discoveries, actual design choices) lives in a separate document:

**[IMPLEMENTATION_NOTES.md](IMPLEMENTATION_NOTES.md)** — M0 through M3 implementation notes.
