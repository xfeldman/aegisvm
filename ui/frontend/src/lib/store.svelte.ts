...
// Unread messages tracking — count only, seq is server-side
...
export function setUnreadMessages(id: string, count: number) { _unreadMessages[id] = count }
export function clearUnreadMessages(id: string) { _unreadMessages[id] = 0 }
